...
// Statement courses
    ...
    $stmt_course->execute();
    $course_data = $stmt_course->fetchAll(PDO::FETCH_ASSOC);
        ...
        <div class="side-bar-wrapper">
            ...
            <div class="side-bar-functions-wrapper">
                <ul class="side-bar-links">
                    ...
                    <li>
                         <span><i class="fas fa-bullhorn"></i> <a href="admin_portal_classes.php"> Notice</a></span> <!-- <i class="fas fa-chevron-down"></i>-->
                    </li>
                    <li>
        ...
        <div class="dashboah-content-wrapper">
            ...
            <div class="course-list-wrapper">
                ...
                <table>
                    ...
                    for ($i= 0; $i < sizeof($course_data) ; $i++) { 
                        echo '<tr>';
                        foreach ($course_data[$i] as $course_item) { ?>
            ...
            <div class="course-form-wrapper">
                ...
                <form action="./includes_/add_course_config.php" method="post">
                    ...
                    <?php  
                        if (isset($_GET['course_id_error'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_id" autocomplete="off" placeholder="Course ID">
                            <span><i class="fab fa-orcid" ></i></span>
                        </div>
                        <p><?= $_GET['course_id_error'] ?> </p>
                    <?php  } elseif (isset($_GET['course_id'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_id" value="<?= $_GET['course_id'] ?>" autocomplete="off" placeholder="Course ID">
                        </div>
                    <?php } ?> 
                    ...
                    <?php  
                        if (isset($_GET['course_title_error'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_title" autocomplete="off" placeholder="Course Title">
                            <span><i class="fas fa-star" ></i></span>
                        </div>
                        <p><?= $_GET['course_title_error'] ?> </p>


                    <?php  } elseif (isset($_GET['course_title'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_title" value="<?= $_GET['course_title'] ?>" autocomplete="off" placeholder="Course Title">
                            <span><i class="fas fa-star" ></i></span>
                        </div>
                    <?php } ?> 
                    ...
                    <!--  -->
                    <?php  
                        if (isset($_GET['course_fee_error'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_fee" autocomplete="off" placeholder="Course Fee">
                            <span><i class="fas fa-cedi-sign" ></i></span>
                        </div>
                        <p><?= $_GET['course_fee_error'] ?> </p>


                    <?php  } elseif (isset($_GET['course_title'])) { ?>
                        <div class="form-item">
                            <input type="text" name="course_fee" value="<?= $_GET['course_fee'] ?>" autocomplete="off" placeholder="Course Fee">
                            <span><i class="fas fa-cedi-sign" ></i></span>
                        </div>
                    <?php } ?> 

                    <div class="form-item">
                        <input type="text" name="course_fee" autocomplete="off" placeholder="Fee amount">
                        <span><i class="fas fa-cedi-sign" ></i></span>
                    </div>
