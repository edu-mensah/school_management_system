        ...
        <div class="side-bar-wrapper">
         ...
         <div class="dashboah-content-wrapper">
            ...
            <div class="buttons-wrapper">
                ...
                <span class="change-batch-class-time">
                    <i class="fas fa-edit" ></i>
                    CHANGE BATCH CLASS TIME 
                </span>
                <span class="change-batch-instructor">
                    <i class="fas fa-edit" ></i>
                    CHANGE BATCH INSTRUCTOR
                </span>
                <span class="change-completion-date">
                    <i class="fas fa-edit" ></i>
                    CHANGE COMPLETION DATE
                </span>
                <span class="change-start-date">
                    <i class="fas fa-edit" ></i>
                    CHANGE START DATE
                </span>
                <span class="change-completion-status">
                    <i class="fas fa-edit" ></i>
